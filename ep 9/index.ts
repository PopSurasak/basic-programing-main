...
console.log(person.fullName())//ต้องมีวงเล็บเสมอ
...
console.log(gaintanaAnime.airing())
...
const football = {
    ...
    champion: function(){
        return this.league.standings.filter(function(element, index){//standingsข้อหัวใหญ่
    ...
    teamlike: function(){
        return this.league.standings.filter(function(element, index){
            return element.team.name === "Arsenal"//ทีมที่ชอบ
        })
    },
    sroceTeam: function(){
        return this.league.standings.filter(function(element, index){
            return element.team.name === "Arsenal"//คะแนนทีมที่ชอบ
        })[0].goalsDiff
    },
    point: function(){
        return this.league.standings.filter(function(element, index){
    ...
    losehome: function(){
        return this.league.standings.filter(function(element, index){
            return element.home.lose > 5 // element.home.lose เขียนแบบนี้เพื่อบอกถึงสิ่งที่ต้องการมากกว่าหนึ่งอย่าง
        })
    },
    loseamay: function(){
        return this.league.standings.filter(function(element, index){
